...
function RecomendationsCard({ recomendations, class_Id }) {
    let { recommendationTitle, recomendationPhrase, recommendationList } =
        recomendations;
                ...
                {recommendationList.map((recomendation, key) => (
                    ...
                    >
                        ...
                        <div className={`recomendation-card-body recomendation-card-body-${class_Id} recomendation-card-body-${class_Id}-${key}`}>
                            ...
                            <a href={recomendation.place_location_link} ><p className={`recomendation-card-body-link recomendation-card-body-link-${class_Id} recomendation-card-body-link-${class_Id}-${key}`}>Ubicacion</p></a>
                        </div>
                    </div>
                ))}
            </div>
